  ...
  return (
    <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg bg-green-50 m-4 shadow-xl">
      ...
      <div className="px-6 pt-4 pb-2">
        <span className="block  font-medium text-sm mr-2 mb-2">Price Per Hour: <span className='text-green-600 font-bold text-xl'>{facility.pricePerHour}$</span></span>
        ...
        <Link className='bg-green-500 hover:bg-green-600 hover:text-white text-white text-base font-medium rounded p-2 px-7 my-2 justify-center' to={`/facility-details/${facility._id}` }>View Details</Link>
        </div>
        {/* <Button
